...
class StoryGameGUI:
    def __init__(self, master):
        ...
        self.background_images = {
            'default': PhotoImage(file=r"C:\Users\saman\Downloads\pexels-riccardo-69903.png"),
            'Bone': PhotoImage(file=r"C:\Users\saman\Downloads\Left_femur_of_extinct_elephant,_Alaska,_Ice_Age_Wellcome_L0057714.png"),
            'Painting':PhotoImage(file=r"C:\Users\saman\Downloads\imageyo.png")
        }

        self.background_label = tk.Label(master, image=self.background_images['default'])
        self.background_label.place(relwidth=1, relheight=1)

        with open(r"C:\Users\saman\AppData\Roaming\JetBrains\PyCharmCE2023.2\scratches\scratch_13.json", 'r') as file:
